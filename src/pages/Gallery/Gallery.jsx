   ...
   <div className={`${styles.gallery} text-white py-5 container-fluid`}>
    ...
    <RowIcons
      ...
      text1={[
        `The first rule of `,
        addBrand(),
        `is, "you do not talk Gallery DK Dojo." Lorem ipsum, dolor sit amet consectetur adipisicing elit. Maxime distinctio tenetur, obcaecati perspiciatis quos.`
      ]}
      ...
      text2={[
        `The second rule of `,
        addBrand(),
        ` is, "you DO NOT talk Gallery DK Dojo." Amet dolores architecto odio dignissimos voluptates veritatis perferendis facilis dolorum beatae non!`
      ]}
